...
export default function UploaderUserInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UploaderUserInfo(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UploaderUserInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
