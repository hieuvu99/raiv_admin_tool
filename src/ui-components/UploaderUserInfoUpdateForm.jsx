...
export default function UploaderUserInfoUpdateForm(props) {
  const {
    id: idProp,
    uploaderUserInfo: uploaderUserInfoModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = uploaderUserInfoRecord
      ? { ...initialValues, ...uploaderUserInfoRecord }
      : initialValues;
  ...
  const [uploaderUserInfoRecord, setUploaderUserInfoRecord] = React.useState(
    uploaderUserInfoModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(UploaderUserInfo, idProp)
        : uploaderUserInfoModelProp;
      setUploaderUserInfoRecord(record);
    };
    queryData();
  }, [idProp, uploaderUserInfoModelProp]);
  React.useEffect(resetStateValues, [uploaderUserInfoRecord]);
  const validations = {
    uuid: [],
    name: [],
    email: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            UploaderUserInfo.copyOf(uploaderUserInfoRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "UploaderUserInfoUpdateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || uploaderUserInfoModelProp)}
