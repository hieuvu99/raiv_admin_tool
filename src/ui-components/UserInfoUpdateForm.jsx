...
export default function UserInfoUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPhraseSubsetIndex(cleanValues.phraseSubsetIndex);
    setProject(cleanValues.project);
    setDob(cleanValues.dob);
    setGender(cleanValues.gender);
    setGeographicLocation(cleanValues.geographicLocation);
    setFirstLanguage(cleanValues.firstLanguage);
    setFluency(cleanValues.fluency);
    setEducation(cleanValues.education);
    setPriorMinCourseTraining(cleanValues.priorMinCourseTraining);
    setSpeechDisorders(cleanValues.speechDisorders);
    setIsTransgender(cleanValues.isTransgender);
    setUid(cleanValues.uid);
    setIsAdmin(cleanValues.isAdmin);
    setIsActive(cleanValues.isActive);
    setIdentityId(cleanValues.identityId);
    setEnabledDailyReminder(cleanValues.enabledDailyReminder);
