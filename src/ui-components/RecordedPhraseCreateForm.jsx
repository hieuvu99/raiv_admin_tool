...
export default function RecordedPhraseCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setRecordedTime(initialValues.recordedTime);
    setLanguageId(initialValues.languageId);
    setIsValidated(initialValues.isValidated);
    setValidationStatus(initialValues.validationStatus);
    setValidationComment(initialValues.validationComment);
    setValidationRating(initialValues.validationRating);
    setValidatedBy(initialValues.validatedBy);
    setValidatedAt(initialValues.validatedAt);
    setErrors({});
  };
  const validations = {
    phraseId: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new RecordedPhrase(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "RecordedPhraseCreateForm")}
      {...rest}
    >
      <TextField
        label="Phrase id"
