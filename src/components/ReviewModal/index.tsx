    ...
    return (
        ...
        >
            ...
            >
                ...
                <View style={{ paddingLeft: "1.5rem", marginBottom: "1rem" }}>
                    <ul style={{ margin: 0, paddingLeft: "1rem", color: "#555", lineHeight: "1.75" }}>
                        <li>Make sure the recording matches the original phrase exactly.</li>
                        <li>No missing, extra, or changed words are allowed.</li>
                        <li>Mismatched recordings can harm AI training by teaching incorrect patterns.</li>
                    </ul>
                </View>
                ...
                <View style={{ paddingLeft: "1.5rem", marginBottom: "1rem" }}>
                    <ul style={{ margin: 0, paddingLeft: "1rem", color: "#555", lineHeight: "1.75" }}>
                        <li>Add a short comment if you notice any issues like background noise, fast speech, or unclear words.</li>
                        <li>Comments help us refine the dataset later for better AI training.</li>
                    </ul>
                </View>

                <View style={{ marginBottom: "1rem" }}>
                    <Text fontSize="1rem" color="#333" lineHeight="1.75">
                        <strong>Why This Matters:</strong> High-quality, correctly spoken recordings are crucial for building accurate and reliable AI models. Your careful review ensures we preserve data integrity and language quality for future generations.
                    </Text>
                </View>
